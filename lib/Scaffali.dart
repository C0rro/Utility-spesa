...
class ScaffaliPage extends StatelessWidget {
  const ScaffaliPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('I tuoi Scaffali'),
      ),
      body: Consumer<DataManager>(
        builder: (context, manager, _) {
          final alimenti = manager.filterByPosizione(posizioni.scaffali);
