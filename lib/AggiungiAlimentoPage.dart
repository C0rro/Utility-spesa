...
class AggiungiAlimentoPage extends StatefulWidget {
  ...
  const AggiungiAlimentoPage({super.key});

  @override
  State<AggiungiAlimentoPage> createState() => _AggiungiAlimentoPageState();
}

class _AggiungiAlimentoPageState extends State<AggiungiAlimentoPage> {
  ...
  void _salvaAlimento() {
    if (_formKey.currentState!.validate() && _dataDiScadenza != null) {
      ...
      final provider = Provider.of<DataManager>(context, listen: false);
      provider.addAlimento(nuovoAlimento);
